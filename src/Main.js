...
const Main = (props) => {
  return (
    ...
    <Btn bgColor={darkGreen} textColor='white' btnLabel="Turn On Detection" Press={() => props.navigation.navigate("Login")} />
    ...
    <Btn bgColor={darkGreen} textColor= 'white' btnLabel="Emergency" Press={() => props.navigation.navigate("khan")} />
    </View>
